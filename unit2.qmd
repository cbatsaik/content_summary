...
- Discussed the concept of genetic ancestry and how it differs from genealogical ancestry.
- Highlighted the challenges of defining ancestry categories, especially when genetic variation exists on a continuum.
- Emphasized the role of recombination and how genetic material is inherited.
- Introduced the concepts of local and global ancestry, which I have explained the distinction above.


## Journal Club 5: "Genes Mirror Geography Within Europe"

- Showed how PCA applied to genetic data can reveal geographical patterns.
- Demonstrated that top principal components often correspond to geographic gradients.
- Emphasized that population structure is a major confounder in GWAS.
- Suggested using PCA as a tool for correcting for population stratification.


## Journal Club 6: "SVMs for Genetic Ancestry"


- Explored the use of Support Vector Machines (SVMs) in classifying genetic ancestry.
- Noted that simple linear models may not be sufficient when ancestry is complex.
- Introduced the concept of using SVMs with kernels to capture nonlinear relationships.
